...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /media/student/data5/cvbridge_build_ws/src/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /media/student/data5/cvbridge_build_ws/devel/.private/image_geometry)
  ...
  set(image_geometry_INSTALL_PREFIX /media/student/data5/cvbridge_build_ws/install)
...
if(NOT "/media/student/data5/cvbridge_build_ws/src/vision_opencv/image_geometry/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/media/student/data5/cvbridge_build_ws/src/vision_opencv/image_geometry/include;/usr/include;/usr/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/student/data5/cvbridge_build_ws/src/vision_opencv/image_geometry/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/student/data5/cvbridge_build_ws/devel/.private/image_geometry/lib;/home/student/catkin_ws/devel/lib;/media/student/data5/cvbridge_build_ws/devel/lib;/opt/ros/melodic/lib)
