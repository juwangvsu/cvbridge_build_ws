...
"""autogenerated by genpy from fla_msgs/FlightEvent.msg. Do not edit."""
import codecs
import sys
...
class FlightEvent(genpy.Message):
  _md5sum = "4110787c7e1d3f4e3706ce25b95d01e2"
  _type = "fla_msgs/FlightEvent"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """uint8 BEGIN=0
uint8 INITIALIZED=1
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FlightEvent, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.event_id,) = _get_struct_B().unpack(str[start:end])
      return self
