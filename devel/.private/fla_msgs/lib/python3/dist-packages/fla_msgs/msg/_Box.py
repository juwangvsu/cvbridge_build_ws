...
"""autogenerated by genpy from fla_msgs/Box.msg. Do not edit."""
import codecs
import sys
...
class Box(genpy.Message):
  _md5sum = "3423b5be7e72312adb724b75aba39e1f"
  _type = "fla_msgs/Box"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Message describing a 3-dimensional rectangular box.
...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_6d().pack(_x.origin.x, _x.origin.y, _x.origin.z, _x.size.x, _x.size.y, _x.size.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.origin.x, _x.origin.y, _x.origin.z, _x.size.x, _x.size.y, _x.size.z,) = _get_struct_6d().unpack(str[start:end])
      return self
