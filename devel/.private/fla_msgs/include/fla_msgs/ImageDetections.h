...
struct ImageDetections_
{
  ...
  _frame_id_type frame_id;
   ...
   typedef std::vector< ::fla_msgs::Detection_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::fla_msgs::Detection_<ContainerAllocator> >::other >  _detections_type;
...
struct MD5Sum< ::fla_msgs::ImageDetections_<ContainerAllocator> >
{
  ...
  {
    return "0d46304a99ef564025aa09dae732b57e";
  }

  static const char* value(const ::fla_msgs::ImageDetections_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x0d46304a99ef5640ULL;
  static const uint64_t static_value2 = 0x25aa09dae732b57eULL;
};
