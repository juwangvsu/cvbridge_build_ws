...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /media/student/data5/cvbridge_build_ws/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /media/student/data5/cvbridge_build_ws/devel/.private/cv_bridge)
  ...
  set(cv_bridge_INSTALL_PREFIX /media/student/data5/cvbridge_build_ws/install)
...
if(NOT "/media/student/data5/cvbridge_build_ws/src/vision_opencv/cv_bridge/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/media/student/data5/cvbridge_build_ws/src/vision_opencv/cv_bridge/include;/usr/include;/usr/include/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/student/data5/cvbridge_build_ws/src/vision_opencv/cv_bridge/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/student/data5/cvbridge_build_ws/devel/.private/cv_bridge/lib;/home/student/catkin_ws/devel/lib;/media/student/data5/cvbridge_build_ws/devel/lib;/opt/ros/melodic/lib)
